...
public class AlfrescoDashboardPage extends AbstractPage {
    ...
    public void logout() {
        element(userButton).waitUntilVisible();
        element(userButton).click();
    ...
    public boolean logoutIfLoggedIn() throws AWTException {
        ...
        clickOnButtonIfExists(By.cssSelector("div.horizontal-widget span#HEADER_USER_MENU_POPUP_text"));
        return clickOnButtonIfExists(By.cssSelector("tbody.dijitReset > tr#HEADER_USER_MENU_LOGOUT > td#HEADER_USER_MENU_LOGOUT_text > a"));
    }
